...
## 前提知識
- 詳細版: [前提知識](/introduction/prerequisites/)
...
- 付録A/B: [コマンドリファレンス](/appendices/a/) / [診断チェックリスト集](/appendices/b/)
- 主要図版: [トラブルシューティングの流れ](/assets/images/diagrams/troubleshooting-process.svg) / [原因分析](/assets/images/diagrams/root-cause-analysis.svg) / [インシデント対応ライフサイクル](/assets/images/diagrams/incident-response-lifecycle.svg) / [監視・可観測性スタック](/assets/images/diagrams/monitoring-observability-stack.svg)
